...
from backtest_engine.transition_engine.fifo.guards_strategies.base import SafeGuardBase
from backtest_engine.transition_engine.fifo.guards_strategies.protocol import SafeGuardProtocol
from backtest_engine.common.types import ResolveContext
