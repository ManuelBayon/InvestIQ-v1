from engine.backtest_engine.bootstraps.common import validate_registry
from engine.backtest_engine.common.enums import (
...
from engine.backtest_engine.transition_engine.fifo.guards_strategies.registry import SafeGuardRegistry
from engine.backtest_engine.transition_engine.fifo.resolve_strategies.registry import FIFOResolveRegistry
from engine.backtest_engine.transition_engine.transition_rules.registry import TransitionRuleRegistry
from engine.backtest_engine.transition_engine.transition_strategies.registry import TransitionStrategyRegistry
...
def _validate_registries(logger: LoggerProtocol) -> None:
    ...
    validate_registry(
        logger,
        "Transition rules",
        "engine.backtest_engine.transition_engine.transition_rules.rules",
    ...
    validate_registry(
        ...
        "engine.backtest_engine.transition_engine.transition_strategies.strategies",
        set(TransitionType),
    ...
    validate_registry(
        ...
        "engine.backtest_engine.transition_engine.fifo.resolve_strategies.strategies",
    ...
    validate_registry(
        ...
        "engine.backtest_engine.transition_engine.fifo.guards_strategies.strategies",
        set(GuardName),
    ...
    validate_registry(
        ...
        "engine.backtest_engine.portfolio.execution_strategies.strategies",
