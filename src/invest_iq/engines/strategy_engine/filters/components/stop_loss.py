...
from invest_iq.engines.strategy_engine.filters.abstract_filter import AbstractFilter, FilterMetadata
from invest_iq.engines.strategy_engine.contracts import FilterInput, FilterOutput, MarketField
...
class StaticStopLossFilter(AbstractFilter):
    ...
    def __init__(
        ...
        self.metadata = FilterMetadata(
            ...
            version="1.0.0",
            description="Applies a static stop-loss based on a fixed percentage drop from the entry price. "
                        "Does not trail. "
