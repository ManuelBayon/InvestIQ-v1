...
from invest_iq.engines.historical_data_engine.request.AbstractRequestSettings import RequestSettings
from invest_iq.engines.historical_data_engine.HistoricalDataLoader import HistoricalDataLoader
...
class HistoricalDataEngine:
    ...
    def load_data(self) -> pd.DataFrame:
        self._logger.info("Initializing historical data engines...")
        self._data_source.connect()
        self._logger.info(" Historical data engines initialized successfully.")
