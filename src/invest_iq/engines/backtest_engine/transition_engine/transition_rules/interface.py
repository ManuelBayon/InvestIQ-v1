...
from invest_iq.engines.backtest_engine.transition_engine.transition_rules.base import TransitionRuleBase
from invest_iq.engines.backtest_engine.transition_engine.transition_rules.protocol import TransitionRuleProtocol
